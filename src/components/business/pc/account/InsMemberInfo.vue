        ...
        <div class="TableWarper">
          ...
          <div class="Content">
            ...
            >
              ...
              <el-form-item prop="PostCode" class="apForm">
                <el-input
                ...
                <el-form-item prop="CountryId" class="apForm">
                  <el-select
                ...
                <div class="provinceList" v-show="provinceList.length>0">
                  <el-form-item prop="Province" class="apForm">
                    <el-select
              ...
              <el-form-item :label="$t('Register.UserGender')" prop="Gender" class="apForm">
                <el-radio-group v-model="ruleForm.Gender">
                  <el-radio label="0">{{$t('Register.UserMale')}}</el-radio>
                  <el-radio label="1">{{$t('Register.UserFemale')}}</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item prop="Language" class="apForm">
                <el-select
...
export default class InsMemberInfo extends Vue {
  ...
  SubmitForm (ruleForm) {
    let that = this;
    console.log(that.ruleForm,'ddddddd');
