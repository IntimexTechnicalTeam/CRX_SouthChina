      ...
      <div>
        ...
        >
          ...
          <div class="login-after-select">
            ...
            <p>
              <router-link
                to="/account/modifyPassword"
                @click.native="closeDialog"
                >{{ $t("MemberInfo.ModifyPassword") }}</router-link
              >
            </p>
            <!-- <p>
            ...
            <p>
              <router-link to="/account/ptxorder" @click.native="closeDialog"
                >{{ $t("Enquiry.Servicestatus") }}</router-link
              >
            </p>
            <p class="logout">
...
.member-icon {
  // background: url("/images/mobile/m_65.jpg") no-repeat center center;
