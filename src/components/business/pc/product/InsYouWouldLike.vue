<template>
  <div :style="styla" v-if="ShowItemsLength>0" class="PcVersionYouLike">
    <div class="NormalTitle">
        <i class="left"></i><span class="center">{{ title }}</span
        ><i class="right"></i>
      </div>
...
.PcVersionYouLike .swiper-button-prev{
      ...
      height: 50px;
      border-radius: 50px;
      background:#f5f5f5 url('/images/mobile/leftTo.png') no-repeat center center!important;
...
.PcVersionYouLike .swiper-button-next{
      ...
      height: 50px;
      border-radius: 50px;
      background: #f5f5f5 url('/images/mobile/rightTo.png') no-repeat center center!important;
      background-size: 20px;
      outline: 0;
      right: 0rem;
}
