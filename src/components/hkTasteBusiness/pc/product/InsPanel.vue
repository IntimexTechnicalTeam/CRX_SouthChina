<template>
  <div class="in_panel_warpper PcVersion" :style="warpperStyle">
    <div class="in_panel_content">
      ...
      ></inSelect>
      <!-- 购物模式 -->
      <div v-if="panelDetail.negotiable == false || panelDetail.negotiable == null" class="Hkshare">
      ...
      <!-- 购物及议价模式 -->
      <div v-if="panelDetail.negotiable == true && panelDetail.negotiateMinQty > panelDetail.MinPurQty" class="Hkshare">
