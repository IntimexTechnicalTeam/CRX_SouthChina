...
export class EnquiryApi extends WSAPI {
  ...
  // 獲取询价详情 /V2/Enquiry/GetMyEditingEnquiry
  GetMyEditingEnquiryV2 (callback: any) {
    return this.instance.get(this.apiPath + '/Enquiry/GetMyEditingEnquiryV2').then((result) => {
      return result.data;
    });
  };
  ...
  AddProdsToMyEnquiry (cond: any) {
    return this.instance.post(this.apiPath + '/Enquiry/AddProdsToMyEnquiry', cond).then((result) => {
      return result;
    });
  };
  ...
  // /V2/Enquiry/GetInviteBidListByBider/{id}
  GetInviteBidListByBider(Id: string, callback: Function) {
    return this.instance.get(this.apiPath + '/Enquiry/GetInviteBidListByBider', { params: { Id: Id } }).then((result) => {
      return result.data;
    });
  };
  // /V2/Enquiry/SaveInviteBidList
  SaveInviteBidList (cond: any) {
    return this.instance.post(this.apiPath + '/Enquiry/SaveInviteBidList', cond).then((result) => {
      return result.data;
    });
  };

  // /V2/Enquiry/SaveBider
  SaveBider (cond: any) {
    return this.instance.post(this.apiPath + '/Enquiry/SaveBider', cond).then((result) => {
      return result.data;
    });
  };
