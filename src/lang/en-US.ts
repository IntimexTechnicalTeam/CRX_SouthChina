export default {
  ...
  Bid: {
    ...
    Supplierregistrationform: 'Supplier Registration Form',
    Signin: 'Sign in',
    EnterCompanyName: 'Please Enter the Company Name',
    EnterEmail: 'Please Enter the Email',
    CorrectEmail: 'Please enter the correct Email Format',
    EnterContactPerson: 'Please Enter The Contact Person',
    EnterPhone: 'Please Enter a Contact Number',
    EnterAddress: 'Please Enter the Company Address',
    OurServices: 'Our Services',
    QueryQuotation: 'Quotation Inquiry',
    Becomeoursupplier: 'Become Our Supplier',
    JoinNow: 'Join Now',
