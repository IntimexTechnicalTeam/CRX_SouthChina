export default {
  ...
  Bid: {
    ...
    Price: '價格 (HKD)',
    Remark: '備註',
    BiddingDocument: '招標文件',
    DeadlineDate: '截止日期',
    QuotationNumber: '報價單號',
    Supplierregistrationform: '供應商登記表格',
    Signin: '登記',
    EnterCompanyName: '請輸入公司名稱',
    EnterEmail: '請輸入電子郵箱',
    CorrectEmail: '請輸入正確的郵箱格式',
    EnterContactPerson: '請輸入公司聯絡人',
    EnterPhone: '請輸入聯絡電話',
    EnterAddress: '請輸入公司地址',
    OurServices: '我們的服務',
    QueryQuotation: '查詢報價',
    Becomeoursupplier: '成為我們的供應商',
    JoinNow: '馬上加入',
    SelectAll: '全选',
    PleaseSelectaPaymentMethod: '請選擇付款方式',
    Pleaseticktheservice: '請勾選服務'
  }
};
